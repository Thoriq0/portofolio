        ...
        <div className="grid gap-10 lg:grid-cols-[1.05fr_.95fr] lg:items-start">
          <Reveal>
            <SectionHeading
              ...
              description="I have spent 1 year and 7 months at PT.Global Edutek Solusindo working on enterprise applications, mostly in environments where the real job is understanding existing systems, fixing what is already live, and improving flows without breaking the business around them."
            />
          </Reveal>
